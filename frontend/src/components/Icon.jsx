// Iconos inline (trazos estilo lucide) para no depender de librerías externas.
const PATHS = {
  ...
  eyeOff: 'M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a20.3 20.3 0 0 1 5.06-6.06M9.9 4.24A10.4 10.4 0 0 1 12 4c7 0 11 8 11 8a20.3 20.3 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24M1 1l22 22',
};
...
export function Avatar({ name = '', className = 'h-8 w-8 text-xs' }) {
  ...
  return (
    <span className={`inline-flex shrink-0 items-center justify-center rounded-full font-semibold text-white ${palette[hash % palette.length]} ${className}`}>
      {initials || '?'}
    </span>
  );
}
